...
namespace EQLogParser
{
    ...
    public class LogOpenEvent : LogEvent
    {
        ...
        public static string GetServerFromFileName(string path)
        {
            ...
            var m = Regex.Match(path, @"eqlog_\w+_(test|beta|agnarr|aradune|bertox|bristle|cazic|coirnav|drinal|erollisi|firiona|luclin|mangler|miragul|mischief|phinigel|povar|ragefire|rizlona|selo|thornblade|rathe|tunare|vox|xegony|zek|vaniki|yelinak|oakwynd|teek|tormax)");
            if (m.Success)
            {
